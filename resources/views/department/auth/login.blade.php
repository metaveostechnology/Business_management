@extends('layouts.dept_app2')

@section('title', 'Department Admin Login')
...
@section('content')
<div class="card">
    <div class="auth-logo">Dept Portal</div>
    <div class="auth-sub">Sign in as Department Admin</div>
    ...
    <form id="loginForm">
        <div class="form-group">
            ...
            <input type="email" id="email" class="form-control" required placeholder="admin@dept.com">
        </div>
...
document.getElementById('loginForm').addEventListener('submit', async (e) => {
    ...
    try {
        const response = await fetch(apiBaseUrl + '/dept-admin/login', {
            method: 'POST',
            headers: {

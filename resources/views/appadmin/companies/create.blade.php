            ...
            <div class="card-body">
                <form action="{{ route('companies.store') }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="email" class="form-label">Email Address (Login ID) <span class="text-danger">*</span></label>
                            <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" name="email" value="{{ old('email') }}" placeholder="contact@acme.com" required>
                            @error('email')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>

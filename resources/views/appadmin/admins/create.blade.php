                ...
                <form action="{{ route('admins.store') }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('username') is-invalid @enderror" id="username" name="username" value="{{ old('username') }}" placeholder="johndoe">
                            @error('username')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="mt-3">
                        ...
                        <a href="{{ route('admins.index') }}" class="btn btn-soft-secondary">Cancel</a>
                    </div>
                </form>
            </div>
        </div>

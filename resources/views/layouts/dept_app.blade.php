<!doctype html>
<html lang="en" data-layout="vertical" data-topbar="light" data-sidebar="gradient-2" data-sidebar-size="lg"
    data-sidebar-image="none" data-preloader="disable" data-theme="default" data-theme-colors="default">

<head>
    <meta charset="utf-8" />
    <title>@yield('title', 'Department Portal') - {{ config('app.name') }}</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="Department Management Portal" name="description" />
...
<body>
    ...
    <div id="layout-wrapper">
        @include('layouts.partials.dept-header')
        @include('layouts.partials.dept-sidebar')
                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Department Portal</a></li>
    ...
    <script>
        ...
        (function () {
            ...
            document.addEventListener('DOMContentLoaded', () => {
                const user = getDeptUser();
                const displayName = user?.name || user?.email || 'Dept Admin';
                document.querySelectorAll('[data-dept-name]').forEach(el => el.textContent = displayName);
            });
        })();

        async function deptLogout() {
            try {
                await apiRequest('/dept-admin/logout', 'POST');
            } catch (_) { }
            localStorage.removeItem('dept_admin_token');
